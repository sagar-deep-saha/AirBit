...
if (isset($_SERVER['REQUEST_METHOD'])) {
    ...
    if ($con) {
        ...
        $cef = $_POST['cef'];
        $ram = $_POST['ram'];
        $sql = "INSERT INTO `airbit`.`red` ( `nake`,`cef`,`comment`, `dt`) VALUES ( '$ced','$cef','$ram', current_timestamp());";
...
<body>
    ...
    <div class="containerx" style="display:flex;">
        <form action="j_search.php" method="POST" class="search-barx">
            <input class="s2x" type="text" placeholder="Type to Search" name="q">
            <button class="A" type="submit"><span class="material-icons dog">search</span></button>
        </form>
    </div>
    ...
    <div style="display:block;">
        ...
        <div id="container2">
            ...
            ?>
                    ...
                    <div class="part3">
                        <form action="j_search.php" method="POST">
