...
<body>
    ...
    <div class="mlx1">
        ...
        <h1 id="mlx4">PROJECT</h1>

        <div class="mlx13">
            <div class="mlx16">
                <br>
                <p>The Project was developed by my group during minor project in 4th semester.</p>
                <p>After that I (Sagar Deep Saha), developed this prject to this.</p>
                <p>Now this project comes under <b>Code Falcon Developers Organisation </b></p>
            </div>
        </div>
