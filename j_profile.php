...
if (isset($_SERVER['REQUEST_METHOD'])) {
    ...
    $result = mysqli_query($con, "SELECT max(id),max(namer),max(skiller),max(cityer),max(stater),max(piner) FROM indexer WHERE namer='$rdx';");
...
<body>
    ...
    <div class="feed">
        ...
        <div class="v1">
            <img class="v2" src="user.png" alt="user-pokeball" />
            ...
            <div class="sidebarOption  , sideOption , v3">
                ...
                <h4 class="k3"> <a href="j_edit.php ">edit</a> </h4>
            </div>
        ...
        <div class="v4">
            ...
            ?>
                    ...
                    <br>
                    <br>
                    <h4 class="v5">STATE :<?php echo $row["max(stater)"]; ?> </h4>
                    <br>
                    <br>
                    <h4 class="v5">PIN :<?php echo $row["max(piner)"]; ?> </h4>
                    <br>
                    <br>
            <?php
                    $i++;
