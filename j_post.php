...
<body>
    ...
    <div style="display:flex;">
        ...
        <div class="container">
            ...
            <form action="j_post-load.php" method="post">
                <input style="display:none" type="text" id="part3id" name="ret" value="<?php echo  $_SESSION['username'] ?>" placeholder="Add a Comment">
                <input type="text" name="lang" class="yt6" placeholder="Add a Language" value="general">
                <textarea name="desc" id="desc" cols="30" rows="10" placeholder="Write the post here" required="required"></textarea>
