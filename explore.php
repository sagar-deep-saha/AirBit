...
if(isset($_SERVER['REQUEST_METHOD'])){
    ...
    $result = mysqli_query($con,"SELECT other,usert FROM yellow WHERE usert ='$df';");

    $rex = mysqli_query($con,"SELECT * FROM login.red join login.yellow WHERE red.cef=yellow.other;");
...
<div class="post" id="container1"></div>
        ...
        <div class="post_body">
            ...
            <div class="part3">
                    ...
                    <input style="display:none" type="text" id="part3id" name="cef" value="<?php echo  $row['usert'] ?>" placeholder="Add a Comment">
            ...
            // $i=0;
            // while($rel = mysqli_fetch_array($rex)) {
            // echo $rel["comment"];
            // $i++;
            // }
            // }else{
